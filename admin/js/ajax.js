     ...
     $.ajax({
      ...
      success : function(data){
        if(data.res == "success")
        {
          Swal.fire(
            'Success',
            'Selected Test successfully deleted',
            'success'
          )
          setTimeout(function(){ 
            window.location.reload();
...
// Add Test 
$(document).on("submit","#addTestFrm" , function(){
  $.post("query/addTestExe.php", $(this).serialize() , function(data){
...
// Update Test 
$(document).on("submit","#updateTestFrm" , function(){
  $.post("query/updateTestExe.php", $(this).serialize() , function(data){
    if(data.res == "success")
    {
      Swal.fire(
          'Update Successfully',
...
// Update Student
$(document).on("submit","#updateStudentFrm" , function(){
