...
<?php 
  ...
  $selExmne = $dbh->query("SELECT * FROM examinee_tbl WHERE exmne_id='$id' ")->fetch(PDO::FETCH_ASSOC);
     ...
     <div class="form-group">
        ...
        <?php 
         ...
         <select class="form-control" name="exCourse">
           ...
           <?php 
             $selCourse = $dbh->query("SELECT * FROM course_tbl WHERE cou_id!='$exmneCourse' ");
